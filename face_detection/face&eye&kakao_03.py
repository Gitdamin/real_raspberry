       ...
       if GPIO.input(18) is 0:
          ...
          while True:
             ...
             for (x,y,w,h) in faces:
                 ...
                 cv2.putText(img, "Outsider detected", (x-5, y-5), font, 0.7, (255,255,255),2)  #얼굴찾았다는 메시지, white color
                 count += 1
